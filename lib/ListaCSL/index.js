import {ListaCirsularSimplementeEnlazada} from './lista.js';
import {ListaCirsularSimplementeEnlazada} from './listaCanvas.js';
...
export async function insertar_al_inicio(){
    ...
    if(lista==null){
        listaCanvas=new ListaCirsularSimplementeEnlazada(canvas);
        lista=new ListaCirsularSimplementeEnlazada(listaCanvas);
    }
